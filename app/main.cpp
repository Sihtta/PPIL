...
int main()
{
    ...
    // 2) Dessin d'une forme simple avant groupement (paragraphe 4)
    cout << "\n--- Dessin d'une forme simple avant groupement ---" << endl;
    dessiner(*cercle);

    // 3) Creation d'un groupe (paragraphe 2)
    ...
    // 4) Calcul des aires (paragraphe 6)
    ...
    // 5) Transformations geometriques (paragraphe 3)
    ...
    Homothetie homothetie(Vecteur2D(250, 200), 1.2);
    ...
    // 7) Chargement depuis le fichier texte (paragraphe 5)
